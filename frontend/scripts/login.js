...
function determineModalContent(description){
    ...
    switch(description){
        case 'empty':
            ...
            dynamicModalMessage.textContent = "Username and password cannot be empty!";
        ...
        case 'u1':
            dynamicModalTitle.textContent = "Login Failed";
            dynamicModalMessage.textContent = "Username must be between 3 and 32 characters long!";
            dynamicModalBtn.textContent = "Try Again";
            dynamicModalBtn.onclick = () => {
                dynamicModal.style.display = 'none';
                loginContainer.style.display = 'flex';
        ...
        case 'u2':
            dynamicModalTitle.textContent = "Login Failed";
            dynamicModalMessage.textContent = "Password must be between 12 and 64 characters long!";
            dynamicModalBtn.textContent = "Try Again";
            dynamicModalBtn.onclick = () => {
                dynamicModal.style.display = 'none';
                loginContainer.style.display = 'flex';
        ...
        case 'success':
            ...
            dynamicModalMessage.textContent = "Welcome back, " + usernameInput.value.trim() + "!";
